...
export default function CustomerFormLeft({
  ...
  const renderOption = React.useCallback(
    (props: React.HTMLAttributes<HTMLLIElement>, option: Customer) => (
    ...
    <Box sx={{ display: "flex", flexDirection: "column", gap: 3 }}>
      ...
      <Box>
        ...
        <Box sx={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 2 }}>
          ...
          <TextField
            ...
            InputProps={{ sx: { height: 32, fontSize: 12, py: 0 } }}
            InputLabelProps={{ sx: { fontSize: 12 } }}
          />
          <FormControl fullWidth size="small">
            <InputLabel id="account-type-label" sx={{ fontSize: 12 }}>
              Account Type
            </InputLabel>
            <Select
        ...
        <Box>
          ...
          <Box sx={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 2 }}>
            ...
            <TextField
              ...
              value={shippingPOBox}
              onChange={(e) => setShippingPOBox(e.target.value)}
              InputProps={{ sx: { height: 32, fontSize: 12, py: 0 } }}
              InputLabelProps={{ sx: { fontSize: 12 } }}
            />
            <TextField
      ...
      <Dialog open={modalOpen} onClose={handleCloseModal} maxWidth="sm" fullWidth>
        ...
        <DialogActions sx={{ marginRight: "15px", marginBottom: "10px" }}>
          ...
          <Button onClick={handleSaveContact} variant="contained" color="primary" disabled={!newContactName.trim()}>
            Save
          </Button>
        </DialogActions>
      </Dialog>
